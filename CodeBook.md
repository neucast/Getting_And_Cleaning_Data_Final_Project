# Code book for Coursera *Getting and Cleaning Data* course final project

The data set that this code book describes, is located in the `tidyData.txt` file of this repository.

You can also read the `README.md` file of this repository for background information on this data set.

Data set is described in the [Data](#data) section. 

The variables are listed in the [Variables](#variables) section.

Transformations are explained in the [Transformations](#transformations) section.

## Data <a name="data"></a>

The `tidyData.txt` data file is a plain file, containing space-separated values.

The first row contains the names of the [Variables](#variables). 
